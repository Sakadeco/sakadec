...
export default function AdminAddRealisation() {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mt-4">Ajouter une réalisation</h1>
        </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    placeholder="Ex: Mariage Élégant - Château de Bordeaux"
                  />
                </div>
