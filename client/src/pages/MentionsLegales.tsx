  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12 max-w-4xl">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-playfair font-bold text-gray-800 mb-6 sm:mb-8">Mentions Légales</h1>
        
        <Card className="mb-4 sm:mb-6">
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Éditeur du site</h2>
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 ml-4 mb-4">
              <li>SKD Shop</li>
              <li>SKD Events</li>
              <li>SKD Rent</li>
              <li>SKD Créa</li>
        ...
        <Card className="mb-4 sm:mb-6">
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Siège social</h2>
        ...
        <Card className="mb-4 sm:mb-6">
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Contact</h2>
            <p className="text-sm sm:text-base text-gray-700 mb-2">
        ...
        <Card className="mb-4 sm:mb-6">
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Hébergement</h2>
            <p className="text-sm sm:text-base text-gray-700">
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Conditions générales</h2>
