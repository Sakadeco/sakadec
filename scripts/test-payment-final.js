// Script pour tester le paiement avec le bon produit
import https from 'https';

console.log('🧪 Test de paiement avec le bon produit...\n');
...
async function testPaymentFinal() {
  try {
    ...
    const testOrder = {
      items: [
        {
          productId: '68a9c4bebf2d893f209588fa', // Produit "texte" qui fonctionne
          quantity: 1,
          price: 5,
          name: 'texte'
        }
