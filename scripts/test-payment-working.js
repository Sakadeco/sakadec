// Script pour tester le paiement avec le produit qui fonctionne
import https from 'https';

console.log('🧪 Test de paiement avec le produit qui fonctionne...\n');

async function testPaymentWorking() {
  try {
    ...
    const testOrder = {
      items: [
        {
          productId: '68f3c542fdf4aba2d84c3fca', // Produit "prod1" qui fonctionne d'après les logs
          quantity: 1,
          price: 12,
          name: 'prod1'
        }
    ...
    if (response.status === 200) {
      ...
      console.log('- Vous devriez recevoir 2 emails :');
      console.log('  1. Facture client avec PDF');
      console.log('  2. Notification admin avec PDF');
      console.log('- Les emails contiennent des factures PDF en pièces jointes');
      console.log('- Les emails sont envoyés automatiquement après le paiement');
...
console.log('✅ Paiement fonctionne (d\'après les logs précédents)');
