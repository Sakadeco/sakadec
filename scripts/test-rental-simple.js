...
async function testRentalProcess() {
  try {
    ...
    // 2. Récupérer le produit "prodloc" directement via MongoDB
    ...
    // 4. Tester l'API GET /api/products
    ...
    // 5. Tester l'API GET /api/products avec catégorie rent
    ...
    // 6. Tester la création d'une location (simulation)
